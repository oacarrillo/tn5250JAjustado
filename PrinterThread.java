...
public class PrinterThread extends Thread implements Printable {
   ...
   public PrinterThread (Screen5250 scr, Font font, int cols, int rows,
      ...
      int ret = scr.GetScreen(screen, len, tn5250j.TN5250jConstants.PLANE_TEXT);
      ret = scr.GetScreen(screenExtendedAttr, len, tn5250j.TN5250jConstants.PLANE_EXTENDED);
      ret = scr.GetScreen(screenAttrPlace, len, tn5250j.TN5250jConstants.PLANE_IS_ATTR_PLACE);
...
//         int pos = 0;
         ...
         for (int m = 0;m < numRows; m++)
            for (int i = 0; i < numCols; i++) {
               ...
               if (screen[getPos(m,i)] >= ' ' && ((screenExtendedAttr[getPos(m,i)] & tn5250j.TN5250jConstants.EXTENDED_5250_NON_DSP) == 0)) {
