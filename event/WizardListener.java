...
public interface WizardListener {
    ...
    * last page.
    */
   public void nextBegin(tn5250j.event.WizardEvent e);

   /**
    * Invoked after advancing to the next page.
    */
   public void nextComplete(tn5250j.event.WizardEvent e);
    ...
    */
   public void previousBegin(tn5250j.event.WizardEvent e);

   /**
    * Invoked after advancing to the previous page.
    */
   public void previousComplete(tn5250j.event.WizardEvent e);

   /**
    * Invoked if a "finish" action is triggered.
    */
   public void finished(tn5250j.event.WizardEvent e);

   /**
    * Invoked if the Cancel action is triggered.
    */
   public void canceled(tn5250j.event.WizardEvent e);
