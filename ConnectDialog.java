...
public class ConnectDialog extends JDialog implements ActionListener, ChangeListener, tn5250j.TN5250jConstants {
   ...
   public ConnectDialog(Frame frame, String title, Properties prop) {
	  ...
	  etnProps = tn5250j.ExternalProgramConfig.getInstance().getEtnPgmProps();
   ...
   private void createAboutPanel() {
	   ...
	   contenpane.add(new JLabel("Version: " + tn5250j.TN5250jConstants.tn5250jRelease + tn5250j.TN5250jConstants.tn5250jVersion + tn5250j.TN5250jConstants.tn5250jSubVer));
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if (e.getActionCommand().equals("ADD")) {
         String systemName = tn5250j.Configure.doEntry((JFrame) getParent(), null,
               props);
         ctm.addSession();
      ...
      if (e.getActionCommand().equals("EDIT")) {
         ...
         tn5250j.Configure.doEntry((JFrame) getParent(), (String) ctm.getValueAt(
               selectedRow, 0), props);
         ctm.chgSession(selectedRow);
         sessions.requestFocus();
      }
	  if (e.getActionCommand().equals("cADD")) {
	         String name = tn5250j.ExternalProgramConfig.doEntry((JFrame) getParent(), null,
					 etnProps);
	  ...
	  if (e.getActionCommand().equals("cEDIT")) {
			 ...
			 tn5250j.ExternalProgramConfig.doEntry((JFrame) getParent(), (String) etm.getValueAt(
   ...
   private void saveProps() {
      ...
      ConfigureFactory.getInstance().saveSettings(ConfigureFactory.SESSIONS,
            "------ Session Information --------");
	  ConfigureFactory.getInstance().saveSettings(tn5250j.ExternalProgramConfig.EXTERNAL_PROGRAM_REGISTRY_KEY,
			  tn5250j.ExternalProgramConfig.EXTERNAL_PROGRAM_PROPERTIES_FILE_NAME,
