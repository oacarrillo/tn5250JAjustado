...
import tn5250j.GuiGraphicBuffer;
...
SessionListener {
	...
	private tn5250j.GuiGraphicBuffer guiGraBuf;
	...
	public void nextSession() {
		...
		fireSessionJump(tn5250j.TN5250jConstants.JUMP_NEXT);

	}

	public void prevSession() {

		fireSessionJump(tn5250j.TN5250jConstants.JUMP_PREVIOUS);
	...
	public String getHostName() {
		...
		return session.getConnectionProperties().getProperty(tn5250j.TN5250jConstants.SESSION_HOST);
	}
