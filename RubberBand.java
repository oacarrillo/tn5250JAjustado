...
import tn5250j.RubberBandCanvasIF;
...
public abstract class RubberBand {
	private volatile tn5250j.RubberBandCanvasIF canvas;
	...
	public RubberBand(tn5250j.RubberBandCanvasIF c) {
		super();
		setCanvas(c);
	...
	public final tn5250j.RubberBandCanvasIF getCanvas()  {
		return this.canvas;
	}
