...
import tn5250j.keyboard.configure.KeyGetter;
import tn5250j.keyboard.configure.KeyGetterInterface;
...
public class KeyConfigure extends JDialog implements ActionListener {
   ...
   private void mapIt() {
      ...
      final tn5250j.keyboard.configure.KeyGetterInterface kg = getMeAKeyProcessor();
