...
import tn5250j.keyboard.DefaultKeyboardHandler;
...
public abstract class KeyboardHandler extends KeyAdapter implements KeyChangeListener {
   ...
   protected tn5250j.keyboard.KeyMapper keyMap;
...
//      }
      ...
      keyMap = new tn5250j.keyboard.KeyMapper();
      tn5250j.keyboard.KeyMapper.init();
