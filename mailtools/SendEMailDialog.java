...
import tn5250j.mailtools.SMTPConfig;
import tn5250j.mailtools.SendEMail;
...
public class SendEMailDialog extends GenericTn5250JFrame implements Runnable  {
	...
	JButton browse;
   boolean sendScreen;
   tn5250j.mailtools.SendEMail sendEMail;
	//OAC - Fortify
		...
		if (!isEMailAvailable()) {
         ...
         this.sendScreen = sendScreen;
			...
			while (result == 0 || result == 2) {
				...
				switch (result) {
					case 0 : // Send it
						sendEMail = new tn5250j.mailtools.SendEMail();
...
//						sendEMail = null;
	 ...
	 * @param sem
	 */
	private void sendIt(Frame parent, tn5250j.mailtools.SendEMail sem) {
