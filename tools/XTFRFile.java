...
import tn5250j.sql.SqlWizard;
import tn5250j.tools.FTP5250Prot;
...
public class XTFRFile
	...
	private tn5250j.tools.FTP5250Prot ftpProtocol;
...
//		setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
	...
	public XTFRFile(Frame parent, tnvt pvt, SessionPanel session, Properties XTFRProps) {
		...
		messageProgress = tn5250j.tools.LangTool.getString("xtfr.messageProgress");
		setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
	}
			...
			Runnable udp = new Runnable() {
				public void run() {
					...
					if (prog >= len) {
						...
						label.setText(tn5250j.tools.LangTool.getString("xtfr.labelComplete"));
	...
	private String getTransferredNote(int len) {
		...
		try {
			return MessageFormat.format(
				tn5250j.tools.LangTool.getString("xtfr.messageTransferred"),
				args);
		} catch (Exception exc) {
	...
	private void initializeMonitor() {
		...
		label.setText(tn5250j.tools.LangTool.getString("xtfr.labelInProgress"));
		note.setText(tn5250j.tools.LangTool.getString("xtfr.labelFileInfo"));
	...
	private void createProgressMonitor() {
		...
		dialog =
			monitor.createDialog(
				this,
				tn5250j.tools.LangTool.getString("xtfr.progressTitle"));
	...
	private void startWizard() {
		...
		try {
			...
			JOptionPane.showMessageDialog(
				this,
				tn5250j.tools.LangTool.getString("messages.noAS400Toolbox"),
				"Error",
	...
	private void initXTFRInfo(Properties XTFRProps) {
		...
		as400p.setBorder(
			BorderFactory.createTitledBorder(
				tn5250j.tools.LangTool.getString("xtfr.labelAS400")));

		as400p.setLayout(new GridBagLayout());

		JLabel snpLabel =
			new JLabel(tn5250j.tools.LangTool.getString("xtfr.labelSystemName"));
		...
		JLabel hfnpLabel = new JLabel(tn5250j.tools.LangTool.getString("xtfr.labelHostFile"));
		gbc = new GridBagConstraints();
		...
		JLabel idpLabel = new JLabel(tn5250j.tools.LangTool.getString("xtfr.labelUserId"));
		gbc = new GridBagConstraints();
		...
		as400p.add(user, gbc);
		// password panel
		JLabel pwpLabel = new JLabel(tn5250j.tools.LangTool.getString("xtfr.labelPassword"));
		gbc = new GridBagConstraints();
		...
		// Query Wizard
		useQuery = new JCheckBox(tn5250j.tools.LangTool.getString("xtfr.labelUseQuery"));
		...
		//query button
		queryWizard = new JButton(tn5250j.tools.LangTool.getString("xtfr.labelQueryWizard"));
		...
		fieldsLabel = new JLabel(tn5250j.tools.LangTool.getString("xtfr.labelFields"));
		gbc = new GridBagConstraints();
		gbc.gridx = 0; gbc.gridy = 5;
		gbc.anchor = GridBagConstraints.WEST;
		gbc.insets = new Insets(5, 10, 5, 5);
		as400p.add(fieldsLabel, gbc);
		allFields = new JRadioButton(tn5250j.tools.LangTool.getString("xtfr.labelAllFields"));
		...
		selectedFields =
			new JRadioButton(tn5250j.tools.LangTool.getString("xtfr.labelSelectedFields"));
		gbc = new GridBagConstraints();
		...
		textDescLabel =
			new JLabel(tn5250j.tools.LangTool.getString("xtfr.labelTxtDesc"));
		gbc = new GridBagConstraints();
		gbc.gridx = 0; gbc.gridy = 6;
		gbc.anchor = GridBagConstraints.WEST;
		gbc.insets = new Insets(5, 10, 5, 5);
		as400p.add(textDescLabel, gbc);
		txtDesc = new JRadioButton(tn5250j.tools.LangTool.getString("xtfr.labelTxtDescFull"));
		...
		intDesc = new JRadioButton(tn5250j.tools.LangTool.getString("xtfr.labelTxtDescInt"));
		gbc = new GridBagConstraints();
		...
		pcp.setBorder(
			BorderFactory.createTitledBorder(
				tn5250j.tools.LangTool.getString("xtfr.labelpc")));

		JLabel pffLabel =
			new JLabel(tn5250j.tools.LangTool.getString("xtfr.labelFileFormat"));
		gbc = new GridBagConstraints();
		gbc.gridx = 0; gbc.gridy = 0;
		gbc.anchor = GridBagConstraints.WEST;
		gbc.insets = new Insets(5, 10, 5, 5);
		...
		customize = new JButton(tn5250j.tools.LangTool.getString("xtfr.labelCustomize"));
		...
		JLabel pcpLabel = new JLabel(tn5250j.tools.LangTool.getString("xtfr.labelPCFile"));
		gbc = new GridBagConstraints();
		gbc.gridx = 0; gbc.gridy = 1;
		gbc.anchor = GridBagConstraints.WEST;
		gbc.insets = new Insets(5, 10, 5, 5);
		...
		JButton browsePC =
			new JButton(tn5250j.tools.LangTool.getString("xtfr.labelPCBrowse"));
		...
		decimalSeparator.addItem(tn5250j.tools.LangTool.getString("xtfr.period"));
		decimalSeparator.addItem(tn5250j.tools.LangTool.getString("xtfr.comma"));
		...
		pcp.add(new JLabel(tn5250j.tools.LangTool.getString("xtfr.labelDecimal")), gbc);
		gbc = new GridBagConstraints();
		gbc.gridx = 1; gbc.gridy = 2;
		gbc.anchor = GridBagConstraints.WEST;
		gbc.fill = GridBagConstraints.HORIZONTAL;
		...
		xtfrButton = new JButton(tn5250j.tools.LangTool.getString("xtfr.labelXTFR"));
		xtfrButton.addActionListener(this);
		xtfrButton.setActionCommand("XTFR");
		op.add(xtfrButton);

		JButton emailButton =
			new JButton(tn5250j.tools.LangTool.getString("xtfr.labelXTFREmail"));
      ...
      // add transfer save information button
		JButton saveButton =
			new JButton(tn5250j.tools.LangTool.getString("xtfr.labelXTFRSave"));
      ...
      // add transfer load information button
		JButton loadButton =
			new JButton(tn5250j.tools.LangTool.getString("xtfr.labelXTFRLoad"));
		...
		//      this.setModal(false);
		//      this.setModal(true);
		this.setTitle(tn5250j.tools.LangTool.getString("xtfr.title"));
...
//      this.saveXTFRFields(xtfrProps);
	...
	private void selectFields() {
		...
		String[] options =
			{
				tn5250j.tools.LangTool.getString("xtfr.tableSelectAll"),
				tn5250j.tools.LangTool.getString("xtfr.tableSelectNone"),
				tn5250j.tools.LangTool.getString("xtfr.tableDone")};
		...
		tn5250j.tools.LangTool.getString("xtfr.titleFieldSelection"),
	...
	class FFDTableModel extends AbstractTableModel {
		...
		final String[] cols =
			{
				tn5250j.tools.LangTool.getString("xtfr.tableColA"),
				tn5250j.tools.LangTool.getString("xtfr.tableColB")};
