...
import tn5250j.tools.encoder.Encoder;
import tn5250j.tools.encoder.EncoderException;
...
public abstract class AbstractImageEncoder implements Encoder {
   ...
   public void encode(Image image, OutputStream os) throws IOException, tn5250j.tools.encoder.EncoderException {
      img = image;
      ofile = os;
      saveImage();
   }

   public void encode(Component component, OutputStream os) throws IOException, tn5250j.tools.encoder.EncoderException {
   ...
   public abstract void saveImage() throws IOException, tn5250j.tools.encoder.EncoderException;
   ...
   */
   ...
   protected void error(String msg) throws tn5250j.tools.encoder.EncoderException {
