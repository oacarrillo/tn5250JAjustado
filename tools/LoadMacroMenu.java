...
public final class LoadMacroMenu {
   ...
   public static void loadMacros(SessionPanel session, JMenu menu) {
      ...
      String[] macrosList = tn5250j.tools.Macronizer.getMacroList();
   ...
   private static void doOptionsPopup(MouseEvent e, SessionPanel session) {
      ...
      action = new AbstractAction(tn5250j.tools.LangTool.getString("popup.delete")
                     + " " + ((JMenuItem)e.getSource()).getText()) {
         private static final long serialVersionUID = 1L;

		public void actionPerformed(ActionEvent e) {
            StringBuffer macro = new StringBuffer(((JMenuItem)e.getSource()).getText());
            macro.delete(0, tn5250j.tools.LangTool.getString("popup.delete").length()+1);
            tn5250j.tools.Macronizer.removeMacroByName(macro.toString());
         }
      };
      ...
      final SessionPanel ses = session;
      action = new AbstractAction(tn5250j.tools.LangTool.getString("popup.execute")
                     + " " + ((JMenuItem)e.getSource()).getText()) {
         private static final long serialVersionUID = 1L;

		public void actionPerformed(ActionEvent e) {
            StringBuffer macro = new StringBuffer(((JMenuItem)e.getSource()).getText());
            macro.delete(0, tn5250j.tools.LangTool.getString("popup.execute").length()+1);
