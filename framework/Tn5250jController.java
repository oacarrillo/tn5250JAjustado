...
import tn5250j.framework.Tn5250jKeyEvents;
import tn5250j.framework.Tn5250jListener;
...
public class Tn5250jController extends Thread {
	...
	private List<tn5250j.framework.Tn5250jEvent> eventList;
	...
	private Tn5250jController() {
		...
		this.setDaemon(true);
		eventList = new ArrayList<tn5250j.framework.Tn5250jEvent>();
		...
		while (true) { //keep on running forever as we are a daemon
			synchronized (eventList) {
				while (!eventList.isEmpty()) {
					final tn5250j.framework.Tn5250jEvent event =
						eventList.remove(0);
	...
	private void broadcastEvent(final tn5250j.framework.Tn5250jEvent event) {
	...
	public void createSession(Screen5250 screen, tnvt vt, SessionPanel ses) {
		final tn5250j.framework.Tn5250jSession session = new Tn5250jSession(screen, vt, ses);
		Iterator<Tn5250jListener> listenerIt = listeners.iterator();
