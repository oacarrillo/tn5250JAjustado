...
import tn5250j.framework.tn5250.DataStreamProducer;
import tn5250j.framework.tn5250.KbdTypesCodePages;
...
import tn5250j.framework.tn5250.Stream5250;
...
public final class tnvt implements Runnable {
    ...
    private tn5250j.framework.tn5250.Stream5250 stream;
    private tn5250j.framework.tn5250.DataStreamProducer producer;
    protected tn5250j.framework.tn5250.Screen5250 screen52;
    ...
    private tn5250j.framework.tn5250.KbdTypesCodePages kbdTypesCodePage;
     ...
     * @param support132
     */
    public tnvt(Session5250 session, tn5250j.framework.tn5250.Screen5250 screen52, boolean type, boolean support132) {
        ...
        try {
            ...
            try {
                SwingUtilities.invokeAndWait(new Runnable() {
                    public void run() {
                        screen52.getOIA().setInputInhibited(tn5250j.framework.tn5250.ScreenOIA.INPUTINHIBITED_SYSTEM_WAIT,
                                tn5250j.framework.tn5250.ScreenOIA.OIA_LEVEL_INPUT_INHIBITED, "X - Connecting");
                    }
                });
            ...
            try {
                SwingUtilities.invokeAndWait(new Runnable() {
                    public void run() {
                        screen52.getOIA().setInputInhibited(tn5250j.framework.tn5250.ScreenOIA.INPUTINHIBITED_NOTINHIBITED,
                                tn5250j.framework.tn5250.ScreenOIA.OIA_LEVEL_INPUT_INHIBITED);
                    }
                });
    ...
    public final boolean disconnect() {
        ...
        if (!connected) {
            screen52.getOIA().setInputInhibited(tn5250j.framework.tn5250.ScreenOIA.INPUTINHIBITED_SYSTEM_WAIT,
                    tn5250j.framework.tn5250.ScreenOIA.OIA_LEVEL_INPUT_INHIBITED, "X - Disconnected");
            return false;
        }
    ...
    private final void readImmediate(int readType) {
        ...
        if (screen52.isStatusErrorCode()) {
            ...
            screen52.setStatus(tn5250j.framework.tn5250.Screen5250.STATUS_ERROR_CODE,
                    tn5250j.framework.tn5250.Screen5250.STATUS_VALUE_OFF, null);
        }
    ...
    private void strpccmd() {
        try {
            int str = 11;
            char c;
            tn5250j.framework.tn5250.ScreenPlanes planes = screen52.getPlanes();
    ...
    private final void fillScreenArray(byte[] sa, int rows, int cols) {
        ...
        tn5250j.framework.tn5250.ScreenPlanes planes = screen52.planes;
    ...
    private final void writeErrorCode() throws Exception {
        ...
        screen52.setStatus(tn5250j.framework.tn5250.Screen5250.STATUS_ERROR_CODE,
                tn5250j.framework.tn5250.Screen5250.STATUS_VALUE_ON, null);
    ...
    public final void setCodePage(String cp) {
        ...
        cp = cp.toLowerCase();
        for (tn5250j.framework.tn5250.KbdTypesCodePages kbdtyp : KbdTypesCodePages.values()) {
