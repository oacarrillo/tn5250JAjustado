...
import tn5250j.framework.tn5250.ScreenFields;
import tn5250j.framework.tn5250.ScreenOIA;
import tn5250j.framework.tn5250.ScreenPlanes;
...
public class Screen5250 {
	...
	private tn5250j.framework.tn5250.ScreenFields screenFields;
	...
	private tn5250j.framework.tn5250.ScreenOIA oia;

	// screen planes
	protected tn5250j.framework.tn5250.ScreenPlanes planes;
	...
	void jbInit() throws Exception {
		...
		oia = new tn5250j.framework.tn5250.ScreenOIA(this);
		oia.setKeyBoardLocked(true);

		lenScreen = numRows * numCols;

		planes = new tn5250j.framework.tn5250.ScreenPlanes(this,numRows);

		screenFields = new tn5250j.framework.tn5250.ScreenFields(this);
	...
	public final tn5250j.framework.tn5250.ScreenOIA getOIA() {
		return oia;
	}
	...
	protected void setStatus(byte attr, byte value, String s) {
		...
		case STATUS_SYSTEM:
			if (value == STATUS_VALUE_ON) {
				oia.setInputInhibited(tn5250j.framework.tn5250.ScreenOIA.INPUTINHIBITED_SYSTEM_WAIT, tn5250j.framework.tn5250.ScreenOIA.OIA_LEVEL_INPUT_INHIBITED, s);
			}
			else {
				oia.setInputInhibited(tn5250j.framework.tn5250.ScreenOIA.INPUTINHIBITED_NOTINHIBITED, tn5250j.framework.tn5250.ScreenOIA.OIA_LEVEL_NOT_INHIBITED,s);
			}
			break;
		...
		case STATUS_ERROR_CODE:
			if (value == STATUS_VALUE_ON) {
				...
				oia.setInputInhibited(tn5250j.framework.tn5250.ScreenOIA.INPUTINHIBITED_SYSTEM_WAIT,
						tn5250j.framework.tn5250.ScreenOIA.OIA_LEVEL_INPUT_ERROR,s);

				sessionVT.signalBell();
			} else {
				oia.setInputInhibited(tn5250j.framework.tn5250.ScreenOIA.INPUTINHIBITED_NOTINHIBITED,
						tn5250j.framework.tn5250.ScreenOIA.OIA_LEVEL_NOT_INHIBITED);
	...
	protected boolean isStatusErrorCode() {
		...
		return oia.getLevel() == tn5250j.framework.tn5250.ScreenOIA.OIA_LEVEL_INPUT_ERROR;
	...
	public void repaintScreen() {
		...
		if (oia.getLevel() == tn5250j.framework.tn5250.ScreenOIA.OIA_LEVEL_INPUT_ERROR) {
			oia.setInputInhibited(tn5250j.framework.tn5250.ScreenOIA.INPUTINHIBITED_SYSTEM_WAIT,
					tn5250j.framework.tn5250.ScreenOIA.OIA_LEVEL_INPUT_ERROR);
		}

		if (oia.getLevel() == tn5250j.framework.tn5250.ScreenOIA.OIA_LEVEL_INPUT_INHIBITED) {
			oia.setInputInhibited(tn5250j.framework.tn5250.ScreenOIA.INPUTINHIBITED_SYSTEM_WAIT,
