...
public class WTDSFParser {
   ...
   private tn5250j.framework.tn5250.Screen5250 screen52;
   private tn5250j.framework.tn5250.tnvt vt;
...
//      catch (Exception e) {};
	...
	protected void createWindow(int depth, int width, int type, boolean gui,
	   ...
	   int numCols = screen52.getColumns();
		...
		w = width;
		char initChar = tn5250j.framework.tn5250.Screen5250.initChar;
